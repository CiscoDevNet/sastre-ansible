...
DOCUMENTATION = """
module: show_alarms
short_description: Display vManage alarms.
description: This show alarms module connects to SD-WAN vManage using HTTP REST to 
             retrieve and display vManage alarms.This module contains multiple arguments with 
...
RETURN = """
stdout:
  description: Status of show alarms
  returned: always apart from low level errors
  type: str
  sample: 'Task show alarms completed successfully'
stdout_lines:
...
def main():
    ...
    try:
        ...
        module.fail_json(msg=f"Show alarms error: {ex}")
