...
options: 
  workdir:
    description: 
    - Backup to directory.By default, it follows the format "backup_<address>_<yyyymmdd>". 
  ...
  archive:
    description: 
    - Backup to zip archive. Location of the archive file is relative to the directory where Ansible script is run.
    required: false
    type: str
  no_rollover:
    description:
