...
| [cisco.sastre.transform_build_recipe](cisco/sastre/docs/cisco.sastre.transform_build_recipe.rst)            | Transform retrieve encrypted passwords                                                                                            |
...
In addition to Ansible itself, [Sastre](https://github.com/CiscoDevNet/sastre) need to be installed in the Python environment being used by Ansible.
